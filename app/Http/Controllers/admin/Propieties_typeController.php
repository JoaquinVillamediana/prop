...
class Propieties_typeController extends Controller {
    ...
    public function index() {
        ...
        return view('admin/propieties_type.index',compact('aPropietie_type'));
    }

    public function create() {
        return view('admin/propieties_type.create');
    }
    ...
    public function store(Request $request) {
        ...
        $userEmail = Propietie_typeModel::where('name', $request['name'])->first();
        ...
        $request['visible'] = ucwords($request['visible']);
       

        Propietie_typeModel::create($request->all());

        return redirect()->route('propieties_type')->with('success', 'Registro actualizado satisfactoriamente');
    }
