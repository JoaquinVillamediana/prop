...
class CargenController extends Controller {

    public function index() {

        //  $aProp = PropietiesModel::get();
        
         $aCargen = CargenModel::get();

         return view('admin/caracteristicas_generales.index',compact('aCargen'));
    }

    public function create() {
        return view('admin/caracteristicas_generales.create');
    }
    ...
    public function store(Request $request) {
        ...
        CargenModel::create($request->all());

        return redirect()->route('caracteristicas_generales.index')->with('success', 'Registro actualizado satisfactoriamente');
    }
