...
<div class="row w-100 main-container">
  ...
  <a class="carousel-control-prev" href="#carouselExampleControls{{$optype->id}}" role="button" data-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next" href="#carouselExampleControls{{$optype->id}}" role="button" data-slide="next">
