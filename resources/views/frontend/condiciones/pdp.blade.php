...
Las empresas indicadas en la cláusula 12, sus empresas afiliadas, subsidiarias o controladoras (en adelante “W.B.O. Software”), respetan la privacidad de toda persona que visite el sitio web enunciado en la cláusula 12 (en adelante, el “Sitio Web”).

Esta Política de Privacidad indica la información que W.B.O. Software puede recopilar y el uso que puede dar a esa información. También explica las medidas de seguridad tomadas para proteger su información, su posibilidad de acceder a su información, y a quién podrá contactar en W.B.O. Software para que sus preguntas en relación con esta Política de Privacidad sean contestadas.
</br>
</br>
2. RECOPILACIÓN Y UTILIZACIÓN DE SU INFORMACIÓN.
</br>
2.1 Esta Política de Privacidad contempla la recopilación y uso de información personal en el Sitio Web.
</br>
2.2 W.B.O. Software no recopilará a través del Sitio Web ninguna información sobre usted que pueda identificarlo personalmente, como, por ejemplo, su nombre, dirección, número de teléfono o dirección de correo electrónico (en adelante, la “Información Personal"), a menos que usted nos la brinde en forma voluntaria. Si usted no desea que recopilemos su Información Personal, por favor absténgase de proporcionarla. Sin embargo, deberá tener en cuenta que en caso de no proporcionarnos su Información Personal, no podrá acceder a los servicios e información disponibles a través del Sitio Web.
</br>
2.3 En caso de que usted nos brinde Información Personal, le comunicamos que esa Información Personal será objeto de tratamiento automatizado e incorporada a la base de datos de W.B.O. Software.
</br>
2.4 W.B.O. Software en ningún momento recopilará información sensible sobre usted.
</br>
</br>
3. INFORMACIÓN PERSONAL.
</br>
3.1 W.B.O. Software recopila Información Personal en línea cuando, entre otros casos:
...
3.3 En los casos que nos brinde su Información Personal, usted acepta y presta su consentimiento libre, expreso e informado para que dicha Información Personal sea utilizada con las finalidades arriba mencionadas y autoriza a que la misma sea tratada, almacenada, recopilada en las bases de datos de propiedad de W.B.O. Software. En tal sentido, usted autoriza a que su Información Personal sea compartida con los clientes de W.B.O. Software. Asimismo, usted acepta y presta su consentimiento libre, expreso e informado con los términos de la presente Política de Privacidad.
</br>
</br>
4. CORREO ELECTRÓNICO.
</br>
4.1 W.B.O. Software podrá enviarle correos electrónicos en relación con el contenido del Sitio Web, los servicios prestados por W.B.O. Software o sobre su cuenta y en respuesta a sus preguntas, pedidos, consultas o comentarios. W.B.O. Software también le podrá enviar correos electrónicos con información sobre productos y servicios ofrecidos por W.B.O. Software y/o terceros asociados comercialmente que le puedan resultar de interés, a menos que usted indique expresamente que no desea recibir dichos correos electrónicos a través de los procesos implementados por W.B.O. Software a tal efecto.
</br>
4.2 Usted podrá solicitar en cualquier momento el retiro o bloqueo de su nombre de la base de datos a la que se refiere la presente Política de Privacidad siguiendo el procedimiento señalado en esta misma política.
</br>
4.3 Todo correo electrónico que reciba de W.B.O. Software le informará cómo rechazar el envío de futuros correos electrónicos promocionales. Asimismo, usted podrá cambiar sus preferencias de recepción de correos electrónicos publicitarios a través de la configuración de su cuenta en el propio Sitio Web en cualquier momento.
</br>
</br>
...
6. COMPARTIENDO SU INFORMACIÓN.
La Información Personal que usted suministre será reputada y tratada como confidencial. Sin perjuicio de lo expuesto, W.B.O. Software podrá compartir total o parcialmente la Información Personal suministrada por usted, incluyendo registros de comportamiento y actividad en el Sitio, contactos a terceros que anuncien u ofrezcan productos o servicios en el Sitio, parámetros de interés de búsquedas así como su historial de búsqueda y preferencias a empresas del grupo W.B.O. Software (para conocer las empresas del grupo W.B.O. Software, ver: http://www.W.B.O. Software.com/es/companies/), y a los anunciantes del Sitio Web, entidades financieras y compañías de seguro de primera línea y reconocida trayectoria con la finalidad de proveerle ofertas, anuncios e información que se ajusten en la mayor medida posible a sus expectativas y preferencias, así como también para permitir la prestación de los servicios ofrecidos a través del Sitio Web y para cumplir con la legislación aplicable.
  </br>
  </br>
7. PROTEGIENDO SU INFORMACIÓN PERSONAL.
</br>
</br>
7.1 Para prevenir acceso no autorizado, mantener la precisión de los datos y asegurar el uso correcto de su Información Personal, W.B.O. Software ha puesto en uso ciertos medios físicos, electrónicos, administrativos y procedimientos de seguridad para resguardar y asegurar la Información Personal que recopilamos en línea. Nosotros resguardamos la Información Personal de acuerdo a estándares y procedimientos de seguridad establecidos y continuamente evaluamos nueva tecnología para proteger esa información. W.B.O. Software garantiza que los procesos internos propios de las bases de datos cumplen con las obligaciones legales de seguridad y confidencialidad impuestas por las leyes de cada país en materia de privacidad y protección de datos personales.
</br>
...
8.1 W.B.O. Software no tiene intenciones de recopilar Información Personal de menores de edad. Cuando corresponda, W.B.O. Software le indicará específicamente a los menores que no brinden esa información Personal en nuestro Sitio Web y/o tomará medidas razonables para obtener el consentimiento de los padres, tutor o representante legal para la entrega de esa Información Personal.
</br>
8.2 Le informamos que en su condición de padre, tutor legal o representante será el responsable de que sus hijos menores o bajo su tutela accedan al Sitio Web, por lo que recomendamos enfáticamente tomar las precauciones oportunas durante la navegación en el Sitio Web. A este fin, le informamos que algunos navegadores permiten configurarse para que los niños no puedan acceder a páginas determinadas.
</br>
</br>
9. LINKS EXTERNOS.
...
descripción clara y precisa de los datos personales sobre los que se busca ejercer alguno de los derechos antes mencionados de acceso, rectificación, oposición, cancelación o revocación, así como la descripción clara y precisa de su solicitud;
fecha y firma del solicitante; y
cualquier otro elemento o documento que facilite la localización de dichos datos personales.
</br>
10.3 Asimismo, si usted se suscribe a alguno de los servicios o comunicaciones que ofrece W.B.O. Software podrá dar de baja su suscripción en cualquier momento siguiendo las instrucciones incluidas en cada comunicación.
</br>
10.4 W.B.O. Software cooperará con las autoridades de cada país cuando éstas requieran formalmente cualquier información relacionada con nuestras bases de datos.
</br>
</br>
11. CAMBIOS A ESTE AVISO DE PRIVACIDAD.
W.B.O. Software se reserva el derecho a modificar esta Política de Privacidad periódicamente, en cuyo caso la política actualizada se publicará en este mismo sitio, siendo obligación de los usuarios revisar regularmente esta sección a fin de informarse de cualquier cambio que se pueda haber producido. De todos modos, W.B.O. Software cursará una comunicación a su cuenta de correo electrónico registrada a efectos de informarle sobre el cambio en la Política de Privacidad.
</br>
</br>
...
12.3 El contacto para ejercer los derechos de acceso, rectificación, actualización y supresión de la Información Personal es: atencionainmobiliarias@tuproximaprop.com.ar
</br>
...
13. CONTACTO.
Si tiene preguntas sobre su privacidad cuando utilice el Sitio Web, por favor contáctenos a los siguientes correos electrónicos de acuerdo con su país:
Argentina: atencionainmobiliarias@tuproximaprop.com.ar
 </p>
</div>
