    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="#">Tipos de Caracteristicas generales</a>
            </li>
            <li class="breadcrumb-item active">Lista de tipos de caracteristicas generales</li>       
        </ol>
        <!-- Example DataTables Card-->
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i> Tipos de caracteristicas generales
                <a class="btn btn-outline-primary ml-4" href="{{ route('caracteristicas_gen_create') }}" role="button">Crear</a>
            </div>         
            <div class="card-body">
